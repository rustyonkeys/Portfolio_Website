...
//                   <div>
//                     <div className="inline-block px-3 py-1 mb-4 rounded bg-white text-black border border-black text-xs font-bold tracking-wider uppercase">
//                       {project.domain}
//                     </div>
//                     <h3 className="text-black font-semibold text-2xl tracking-tight mb-2 leading-snug">
//                       {project.title}
//                     </h3>
...
//                 {/* Category / Subtitle */}
//                 <div className="inline-block px-4 py-1.5 rounded bg-white border border-black text-black text-xs font-bold uppercase tracking-widest w-fit mb-5">
//                   {selectedProject.domain}
//                 </div>

//                 {/* Project Title */}
//                 <h3 className="text-3xl md:text-5xl font-bold text-black mb-6 leading-tight tracking-tighter">
//                   {selectedProject.title}
//                 </h3>

//                 {/* Highlights (Timeline, etc.) */}
//                 <div className="flex flex-wrap items-center gap-6 text-black mb-8 pb-8 border-b border-black">
//                   <div className="flex items-center gap-2">
//                     <Clock size={18} className="text-black" />
//                     <span className="font-semibold text-black">Duration:</span>
//                     <span className="text-black">{selectedProject.daysRequired}</span>
//                   </div>
//                 </div>

//                 {/* Description */}
//                 <div className="prose max-w-none">
//                   <h4 className="text-lg font-semibold text-black mb-3 tracking-tight">About the Project</h4>
//                   <p className="text-black leading-relaxed text-[1.05rem]">
