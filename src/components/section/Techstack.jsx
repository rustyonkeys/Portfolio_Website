...
export default function TechStack() {
  ...
  return (
    <section className="w-full min-h-[50vh] flex flex-col items-center justify-center bg-black relative">
      ...
      <div className="relative overflow-hidden w-full pt-56"> {/* Increased padding */}
        ...
        >
          {marqueeItems.map((tech, index) => (
            <li
              key={`${tech}-${index}`}
              className="text-5xl font-lato text-white flex items-center"
            >
